...
>
class WvScatterMap : public WvScatterHash<WvPair<TKey, TData>, TKey,
        WvScatterMap<TKey, TData, Comparator>, Comparator>
{
protected:
    typedef WvPair<TKey, TData> MyPair;
    typedef WvScatterMap<TKey, TData, Comparator> MyMap;
    typedef WvScatterHash<MyPair, TKey, MyMap, Comparator> MyHashTable;
...
public:
    WvScatterMap(int s) : MyHashTable(s)    { };
    /* May return NULL!! */
